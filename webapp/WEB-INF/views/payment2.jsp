...
onunload=" ">
  ...
  <c:url var="myaction" value='/session/printTicket'/>
<br>
<br>
<br>
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
            <div id="pay-invoice" class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="${myaction}" method="post" name="payment2">
                        ...
                        <div class="form-group has-success">
                            ...
                            <input id="cc-name" name="cc-name" type="text" class="form-control cc-name"  onchange="return validate1();">
                           <!--  <span class="invalid-feedback">Enter the name as shown on credit card</span> -->
                        </div>
                        <div class="form-group">
                            <label for="cc-number" class="control-label mb-1">Card number</label>
                            <input id="cc-number" name="cc-number" type="tel" class="form-control cc-number identified visa" onchange="return validate2();">
							...
							<div class="row">
								<div class="col-6">
									<div class="form-group">
										<label for="cc-exp" class="control-label mb-1">Expiration
											Date</label> 
											
											<select class="form-control" class="row">
								...
								<div class="col-6">
									...
									<div class="input-group">
										<input id="x_card_code" name="x_card_code" type="tel"
											class="form-control cc-cvc" onchange="return validate3();">
...
function myFunction() {
  ...
  window.location.replace = "/http://localhost:8082/901_AirlinesProject/";
} 
</script> -->
                    </form>
                </div>
 ...
 <script type="text/javascript">
		function validate1() {
			...
			if ( name == null ) 
			{
				alert("Please enter your card name, invalid format");
	...
	<script type="text/javascript">
		function validate2() {
			...
			//var strSource = s.options[s.selectedIndex].value;
			  var pattern2= /^(?:4[0-9]{12}(?:[0-9]{3})?)$/;
     
			  if ( number == ""  )
			{
				alert("Please enter your card number, invalid format");
				//this.getField("destination").setFocus();
				//	return false;
			}
		}
	...
	<script type="text/javascript">
		function validate3() {
			...
			//var strSource = s.options[s.selectedIndex].value;
			  ...
			  if ( cvv == ""  )
			{
				alert("Please enter your CVV, invalid format");
				//this.getField("destination").setFocus();
				//	return false;
			}
		}
